  ...
  return <div className="app-shell">
    ...
    <main className="main-area">
      <header className="topbar">
        ...
        <div className="top-actions"><button className="icon-button"><Bell size={19}/><span className="notification-dot"/></button><div className="avatar">MA</div><div className="profile-copy"><strong>Michael Acuña</strong><span>Administrator</span></div><LogoutButton /></div>
      </header>
